...
# Base|Desktop|Master-Admin|  'dev-'|Prod ''
...
# Desktop-Version-Sh-Master-Admin |'dev-'|Prod '' (+login) Profile ШМ
...
# Mobile|SH|  'dev-'|Prod '' (+login) Profile ШМ
